...
from utils.config_loader import (get_model_config, create_standard_message, create_plan_message, create_request_message,
...
class OrchestratorAgent:
    ...
    def handle_agent_message(self, message):
        ...
        print(f"Received message: {message_to_chat_message(message)}")
    ...
    def send_message_to_agent(self, to_agent, message):
        ...
        print(f"Sending message: {message_to_chat_message(message)}")
